...
So you’ve learned storytelling. A story is a series of events where a character works hard to overcome a problem. Storytellersmust only tell the story and resist the urge to be self-indulgent and trick their audience with atttemps at being interesting.

Staying on target isn’t easy. Stories are created over many hours. Throughout writing sessions a creator must keep on target. Whether sick, hungry, about to get married or living through a war, the creator must detach from their feelings and return to his make believe storyworld.

Creating a consistent series of events that makes a good story is crueling. The turn to interesting scenes like grosteque gore or self-indulgent talk is the mark of a writer not willing to stay in the dirt and work hard to create. 

What does a writer use to guide his work? We can take the lessons of Mamet and Aristotle’s take on storytelling and make some tools for creators.
...
Of course some items don’t fade into the background. Occasionally a set will be beautiful and attract attention. And sometimes an item will be very important, like the glass slipper in Cinderella for example.
...
Dialogue is how we know what the characters are declaring what they want be it to destroy the Death Star or marry prince charming.

### Antagonist
While props, music, and dialogue communicate the story to the audience, it’s the characters who live the story. They are human stand-ins for the audience. Fans of the story will see themselves as one of its character.
...
Every story has a problem to overcome. Antagonist personifies the the problem and he represents the way the world is and doesn’t want the world to change. 
...
Cinderella is told she's not good enough for prince charming. When she disregards these rules, she's locked up in the attic. The lever of power here is the key to the door and trying on the glass slipper to prove she is the real princess. In the Pig Story, the leve of power is the leash  and the bill of sale which farmer John wants to get someone to sign and the pig doesn’t. 

Whoever controls the levers controls society and can write the rules because they can enforce the rules. The levers can be as simple as the glass slipper or as devastating as the Death Star.

Every story is about a hero having a problem in the worlview that’s enforced with a lever or power. Since debates don’t change much, true heroes attack the levers of power by destroying, seizing, or creating new ones.

And that’s what a story is. A series of beats and scenes that come together to make a plot where the hero and villian battle for control over a lever of power. Incidents should be logical and follow naturally from the actions that precede them. The incidents will be more satisfying to the audience if they come as a surprise, and if the audience at first thinks them to be coincidence; soon, however, the audience must see them as plausible, even necessary.
...
**Worldview:** The thought of Star Wars is the Force. It is the mystical power in the story. The good Jedi harness it to empower people with freedom and knowledge. The evil Sith like Darth Vader use the Force to impose their rule over the galaxy.
...
**Plot:** The Death Star is the ulimate lever or power. And it’s blueprints drive the plot of the story. Princess Leia stole them and enlists help to deliver them to the rebels. After several set backs and realizations, Obi-Wan, Luke, and Han help her deliver the plans. Ultimately, it's Luke who uses the Force to destroy the Deathstar and change the world in the story's climax.
</template>
...
<button class="t-btn" @click="pigthree=false; swthree=false; cinthree=false;maxthree=true">The Matrix</button>
...
Not every story is well told. Many don't follow the rules Aristotle and Mamet teach. There are three possibilities for a story.
...
A story is character working hard to solve a problem. Stories have perspective. As mentioned already, they are not debates with a Socrates like philosopher weighing all the options without biased. Heroes act and we're supporting their story. The antagonist is our enemy because she defends the problem.

We can still gain perspective ourselves by seeing how some of our beloved stories differ if told through the eyes of the antagonist.
...
We can track the degration. It is one of good story degrading into spectacle.
