...
Depending on the food, cooking can reduce the energy cost of digestion by roughly 10-30%. The first cooked food was likely the charred remains left after forest and grassland fires. The first campfires were likely started from the embers of those same fires. Humans just had to emulate lightning to master starting flames when we wanted them. Once we did, we cooked food as needed. We kept going, and built kilns to turn clay into pottery and forges to turn tin and copper into bronze, and thus started civilization.

From the campfires on the African Savannah, the foods we eat, the homes we stay in, and the water we store have been linked to technological development.

But there's nothing supernatural about technology. It's composed of nature, and is thus a natural part of the Game of Life. What became artificial is the method used to select tools of the ecosystems. The first white bear didn't interview for a job hunting seals in the Arctic. Brown bears can't lobby against polar bears venturing south today looking for meals. They can only play the game. But when our big brains, self-awareness, and storytelling mix with biological self-interest—especially while holding powerful tools—the result can be unnatural.

We see others not as technological operators in the ecosystem that sustains us, but biological tribe members or outsiders, based on an ever-changing identity such as gender, race, ethnicity, nations etc.

This worked okay when technology was so primitive we still spent much of our time living, harvesting, and depending on the biological ecosystems.

However, in 2020, researchers calculated something remarkable.

The total weight of everything humans have built—buildings, vehicles, infrastructure, plastic, concrete—now exceeds the total weight of all living biomass on Earth. The technosphere weighs more than the biosphere. When technology is powered by electricity, built with robots, designed with AI, and outweighs all life put together, we can't keep pretending our primary identity is rooted in the genetics of ancient humans or the cultures of the past.
...
The last century demonstrated the failure of human storytelling to control natural events twice. We met both attempts in the introduction: fascism and communism, each convinced it had found the engine of human success, each bound to fail at enormous cost. Here is how the inevitable failures played out.

One belief system looked at us and saw only genotype: each person is solely defined by their bloodline, so purge the dead weight of the species and promote and empower the supermen to replace them. The other saw only phenotype: remake the human condition by empowering educated decision-makers to engineer a society to make better humans.
...
Soviet science made the opposite wager. Instead of genetics making a person, they thought the environment did. So, they revived Lamarckism, an old idea Darwin's work had displaced. This theory said heredity could change based on environmental factors. Meaning for example, we can "teach" wheat to flower on different seasons and its offspring will inherit this new adaptation. When respected Soviet researchers like Nikolai Koltsov and Nikolai Vavilov rightfully disagreed they were persecuted or killed. By 1948 genetic research itself was banned. The result was a supposed scientific proof that any plant or person would prosper in any environment, if only it were properly conditioned for it. Famines soon followed to no farmers suprise.
...
Let's look at World War II (1939-1945) for our first example why. This history is told in many books (my favorite being _Why the Allies Won_), but Germany's early World War II victories came from a real innovation—integrating tank, plane, and infantry by radio into concentrated and fast-acting "combined arms" mobile warfare. These ideas were in contrast to the World War I where soldiers, tanks, planes, artillery were spread across the battlefield and attacked each other in waves. Soldiers relayed observations to commanders far away from the battlefied and waited days for orders on what to do next.

Austrailian World War I general John Monash was a part-time general but full-time engineer. He saw warfare as a problem to solve. He learned to coordiate his soldiers, tanks, and planes to support each other. His ideas culminated in the The Battle of Hamel (1918), which was a brilliant success with unusually low casualties. But the war ended months later, so the Allies never adopted his methods. Instead, victory over invading Germans was credited to strong bunkers and defensive strategy. Combined arms textbooks were written by British theorists. The Allied leadership read them, but never implemented them.

In contrast, World War I taught every German that they can't win long wars of attrition. From the generals to the soldiers, no one had no reason to preserve World War I mentalities. So, when they read the British theorists, they wrote a practical guide to combined arms warfare called "Beware the Tank!".

The German military took the book to heart. They practiced concentrating many trucks, tanks, planes, and artillery like a sword point at the gaps in the enemy's forces. More importantly, using radio, soldiers talked directly to each other and could share intelligence on enemy positions and then coordinate movements and attacks at relative small sizes and at high speed. They called combined arms warfare "Blitzkrieg", or lightning warfare.

Gas engines and radio telecommunications were worldwide technologies. They were transforming everyone's society. Thus, the Allies built tanks, planes, and trucks just like the Germans did. But their leaders had built their careers on World War I methods, so combined arms ideas were filtered out with every training session and promotion. The military trained themselves not to see the environment as individual success became referencing leaders thoughts Portable radios, fast moving tanks, powerful airplanes kept being assigned to units, spread far apart, often behind bunkers, and connected by layers of commanders relaying orders and assuming they had time to wait for instructions. 
...
The West was different. Not by intent, but by structure. The power to create and modify society and technology was placed in many hands. Legislatures, courts, states, churches, universities, and private companies each held a piece, and none held enough to purge a whole category of persons or ideas. Exclusion and oppression were real, and often brutal. But they were never total, because there was always another jurisdiction, another employer, another lab.

We learned earlier that Milgram's participants shocked a man for failing to remember, with the pencils that would have helped him sitting right there on the table. With power spread across so many centers, someone in the West could always make, hand over, or pick up a pencil regardless of what others did. Although the interwar years should complacency could still take grip, they still responded faster then either extreme ever could. Dreamers could always dream, risk-takers could take risks, the state funded, the academics found somewhere to research, and customers were free to buy. So because "technology is anything that was not around when you were born," nobody could stop the constant learning that technological evolution requires of us.

This is the biggest reason why the Allies won World War II. Besides enjoy what historians call "The Long Peace" of that achievement, you are likely holding the fruits of a moderate society in your hand right now. Here's the story of how the wonderful system of checks and balances created computers.
