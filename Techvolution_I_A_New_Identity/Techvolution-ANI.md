...
We attempted to do so, but we only saw our genotype or phenotype in our reflection, and were destined to fail. Remember that evolution does not prescribe good ideas; it simply selects out the bad ones. Two of the worst ideas ever subjected to evolutionary forces were fascism and communism. These two ideologies attempted to purify either the genotype or phenotype and thereby impose their own selective criteria on humanity through eugenics and social engineering, respectively.

Of course, humanity has had many bad ideas before. But fascism and communism were particularly horrible because they had access to modern science, which they tried to use to validate their premises. Genotype-focused fascist and Nazi scientists developed theories that attributed human success solely to genetics—for example, they thought head shape determined intelligence. Phenotype-focused communist and Soviet scientists insisted on absolute genetic equality, attributing all success to environmental factors such as upbringing and education, and even insisted any plant could prosper in any environment with the correct habituation.

With access to modern machinery, mathematics, and other advancements, one ideology enacted mass imprisonment, forced sterilization, and the Holocaust, while the other did mass incarcerations, mass executions, and caused devastating famines through agricultural policies that collectivized farmland, criminalized genetic studies, and planted crops in climates any farmer would know were doomed.

However, as awful as it might sound, the problem isn't that an extreme couldn't have a technological success. Each was doomed because neither could sustain its achievements; extremes have complacency embedded in them.

Let's look at World War II (1939-1945) for an example. This history is told in many books (my favorite being _Why the Allies Won_), but Germany's early WWII victories in its invasion of Poland (1939) came from a real innovation—integrating tank, plane, and infantry by radio into fast-acting "combined arms" mobile warfare. These ideas were partly borrowed from British academies and proved very effective when turned against slower, hierarchical Allied armies still using massive bunkers and creaky, slow command structures. When Germany turned its Blitzkrieg toward Holland, Belgium, and France (1940), it won in six weeks the decisive victory that four years of warfare in World War I (1914-1918) could not deliver.

But the Nazis read early wins as proof of their superiority rather than the application of tools anyone can emulate. Military complacency set in quickly. With Western Europe in hell, they thought "racially inferior" Soviets would be a push-over in their next invasion (1941). At an egregious cost in Soviet life and property, within a few years the Soviets were fielding better tanks and planes and approaching German military command sophistication. For its part, the Allies did much better too, especially America. They quickly replaced their aged commanders with the likes of Bradley, Patton, and Eisenhower. They turned a 200,000-man army and a struggling economy into an 8-million-man army making bombers, tanks, and ships at record pace and operated combined arms mobile warfare better than Germany ever had.

Nazi Germany, so obsessed with racial explanations for its success, couldn't compete, and hoped in vain that its self-declared intelligence advantage would create "wunderweapons" to save them. They were overrun anyway, and Nazi leaders called for the nation's own destruction for having failed the racial test of history. Note that the other major member of the Axis, Imperial Japan, had a similar racial theory, early success, and ultimate failure too.

Extremism would soon fail the Soviets as well. Despite early triumphs like the first satellite (1957), getting probes to Venus (1966-1983), and rovers on the Moon (1970-1973), Soviet technological progress stalled. Their economy had no "people in a garage," no small businesses, no independent universities, but relied almost entirely on state-supervised research and production facilities. Perhaps worst of all, Soviet leaders never opened up scientific or technological development to regular people. Without independent research or private property, there was no "creative destruction", no ability to blow caution to the wind, try new things, and see what works.

In contrast, when America put rockets in space, average citizens were following in real-time on electronics sharing the same technology. As Soviet innovation stopped in the 1970s, the Soviet Union grew ever more dependent on oil exports to fund a bloated state bureaucracy and military. It decided to buy the advanced industrial equipment it could no longer produce itself. When oil prices fell in the 1980s, the entire Soviet system imploded as its various peoples either voted to abandon it or watched as even once-committed believers let the communist project die.

The lesson to learn is that defining human success as either a genotype or phenotype is a dead-end. You need a diversity of genotypes and phenotypes for any ecosystem to prosper. Darwin showed this is how nature works best. Different lifeforms supporting each other while fighting at the edges. Biological ecosystems worldwide showcase it. Even ones in your local city park. While many would be used to seeing landscapers plant a few trees at a time, the Miyawaki Method proves life can sustain so much more. This technique plants many native species densely in a small plot to mimic natural forest regeneration. It grows a healthier, faster forest than any single species could manage alone.

Eugenics and social engineering were tried in the West too, but perhaps because our ideologies predate evolutionary understanding, we could move past them more easily. For example, during World War II, Allied societies proved more adaptable under the same wartime pressure. Allied economies trained women to weld ships and planes, started—imperfectly—to end racial segregation in their militaries, and let private business produce weapons under government supervision. That adaptability survives today as the ordinary divide between conservatives and progressives: one emphasizing wealth generated through individual effort and minimal government, the other wealth distributed to overcome inequality through targeted programs to help society prosper.

Here's one example of how mixing both ideas works so well.

In 1945, a technical genius envisioned the world we live in today. Before anyone sent an email or browsed Wikipedia, a vice president of the Massachusetts Institute of Technology, Vannevar Bush, thought it up in works such as "As We May Think." He was fighting World War II, and dreamed computer technology would cure the human condition.

These visionaries are hard to come by. Yet they exist in every society. The key is how to bring their ideas to life.

We already learned it's not by concentrating on genotype or phenotype extremes, but by following nature and allowing both personal ambition and collective benefit to cohabit and build together.

The invention, development, and proliferation of the tiny transistor makes the point very well. It came from a partnership no single ideology contains: government demand, private enterprise, open research, and open market fused into one pipeline. Vannevar Bush embodied it. He was the dean of MIT School of Engineering, a Raytheon founder, and America's wartime science chief. He described how to fund this system in "Science, the Endless Frontier."

The transistor is a great example of the pipeline's success. It was discovered at Bell Labs, an open research lab (1947). Its expensive, uncertain early development was paid for by military and NASA contracts to companies like Fairchild Semiconductor. With the resources and incentive, these scientists soon turned a single transistor into the first integrated circuits (1959), and within a decade these chips were packing hundreds.

Transistor advancement continued, increasingly in a competitive market.

As rocket, pocket calculator, and transistor radio sales exploded, western scientists found—or were offered—funding to leave their universities and employers to start their own firms. These newcomers drove development into overdrive, and soon Intel invented the microprocessor with thousands of transistors that could be reprogrammed for different applications (1971). Within a few decades the transistor went from being unknown, to the size of a pencil eraser, to powering home computers. This same method produced not only microprocessors, but the internet, personal computers, and many other wonders in an ongoing wheel of research and development. Soviet thinkers wrote great theories about the future, but could only watch and envy while others built it. The Nazi and Imperial Japanese regimes were long dead. Like a monoculture garden, each was undone by its own extreme.

A profit-obsessed person plants few trees and values monocultures. A diversity-obsessed person plants for novelty and invites foreign species. A moderate person merges both and plants many diverse local plants. Thereby these plants prosper inside a healthy ecosystem. This mix of cooperation and conflict works the same for technological ecosystems too.

Inside this pipeline, any temperament finds a home. The pipeline is structural, so no camp can skip a stage. The conflict is distributional—how much public money, who captures the profit, who carries the risk. That fight is real and never ends. But it rides on a partnership none of them should ever opt out of.
...
All our endless menus and tastes are a reflection of the endless variety of humans, but all of us eat to save energy. Actually, biological energy, as we need to harvest energy from oil, wood, gas, electricity to cook. The point is from those first campfires on the African Savannah, we've been linked to technological development.
