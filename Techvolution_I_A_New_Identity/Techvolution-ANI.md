...
Rome was not built in a day and dinosaurs weren't born in a million. All of life's extravagance has come in small iterative steps. Although slow, evolution is a universal, unstoppable force that we can see in real-time naturally selecting some individuals over others.
...
The point is that while families, flocks, species, ecosystems share much in common, it is each individual that pushes life forward. There is no group think, because there is no shared selection. Communication exists of course, and genes, kin, groups have selection importance too, but for any evolutionary change, it is one person at a time.
