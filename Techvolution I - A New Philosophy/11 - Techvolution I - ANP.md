...
This sort of mentality unearthed a long time ago. The Industrial Age started when the steam engine powered the world’s first production lines of wheels, lathes, drills, and presses. Even with this mechanical power, mass-producing trains, clothes, and newspapers needed a lot of manpower. Workers were machines who needed managers to be task-masters. There was no other way to be sure people were coordinated to the strict rhythmn of the production line. Look below, and you’ll see a how our factory working ancestors lived.
...
Today we don’t work on the assembly line with bulky steam engines or massive presses. Much of industrial production is automated (or, sadly, outsourced). Most Westerners work in the service economy inside in hospitals, retail stores [https://www.bls.gov/emp/tables/employment-by-major-industry-sector.htm], or in an office. It’s time for these workplaces to transform the same way the manufacturing already has. We modernize them today by empowering workers and customers to collaborate directly. Just as the Industrial Age enabled mass-production, the Internet Age enables mass-collaboration.

Main Street is already starting to collaborate. For example, when we Google something, the advanced search engine is helping us find answers other people people have made on their own websites. That's how Google facilitates mass-collaboration. What prevents this kind of time-savings at work is excessive management.

Prior to the Industrial Age, when you spoke with an innkeeper, blacksmith, tailor, coach driver there was nobody "above" them except maybe the owner, or master craftsman. Every person had a skillset and was the controller of how to use it. It was the industrialization of work that got rid of these specialists from our economy and gave us a culture of management. Software, however, flips the power dynamic.

That's why Airbnb gives innkeepers, Uber gives coach drivers, and Etsy gives blacksmiths and tailors back the levers of power. The Internet Age will continue to take the levers of power from managers and give it to programmers, underwriters, and other newly (remade) player gods.

This change can't happen too soon. Our culture of micro-management by layers of management is rotting our economy. While we'll always need mentors, authority figures, and administrators (especially in massive industries). There's been a huge bureaucratic creep since 1970. Increases of hundreds to thousands of percent are common. For example, in 1994, famed aerospace engineer Ben Rich (who created stealth technology) said only abour 45 percent of a procurement budget actually is spent producing the hardware. The rest goes to bureaucratic madness. Which is why development costs of fighter jets increased by a factor of 100 since the 1950s.

Today there’s an entire class of consultants, administrators, managers, and executives who don’t know the skills of their respective industry like nursing, engineering, and (definitely not) cleaning. Their power is simply to be middlemen who create and distribute things like useless memos.
...
The realness of "Office Space" can only be appreciated by people working on today's frontline. We still need mentors, administrators, and leaders. But, not "eight different bosses"; which is not an exaggeration. The next time your at a fast-food place, ask to speak to the decision-maker, and you wont get the cook or owner, but a corporate directory that never ends.

Prior to the Industrial Age you'd speak with the innkeeper, cook, or blacksmith, get your answer, and go back to living your life. Which is also how the Internet Age will work too.

Today's class of managers wants to keep things the same. And this creates much antagonism—primarily because we can see mass-collaboration of frontline specialists working already. It typically goes by the name “Wikinomics,” and it’s sweeping through our economy. There are countless examples in the open-source community alone. Each open-source project showcases mass-collaboration. The community comes together to make a core technology. Groups then use the core technology to create specialized products.
...
In my experience (and this is after processing 10,000 insurance claims) the vast majority of people just want to go on with their lives. It's only when they're misled, disadvantaged, and left in the dark that drives regular folk to lash out. Open information, with easy to follow rules, are reasonable and thus gets the most out of people. Especially it makes cheating the system harder.
...
Open-source hero Linus Torvalds explained it as “Money is not the greatest of motivator. Folks do their best work when they are driven by passion. When they are having fun. This is as true for playwrights and sculptors and entrepreneurs as it is for software engineers.” It's the job of leaders to insprire passion. It's bad (or needless) coaches who blame their players for their own bad leadership. Torvalds concludes “What astonishes so many people is that the open source model actually works.”
