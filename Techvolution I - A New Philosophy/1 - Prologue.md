...
People often say we’re addicted to our phones. We aren’t. Checking news feeds, downloading ping-pong games, taking endless photos, is learning what our new tools can do. Our ancestors did the same when printed books, cheap muskets, and telescope, empowered them to read, fight tyrants, and see the universe for themselves.

That's why we're addicted to your phones. Because they're a new tool, a lightsaber, set to destroy the gatekeepers of old tools, once a new philosophy turns them on. That’s Techvolution.
