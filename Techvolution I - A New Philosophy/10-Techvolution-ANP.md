...
One claim was particularly illuminating. It was for a gentleman named Dylan. He and his wife were driving down to Florida for a vacation. He had a large SUV and paid a shop to install a tow hitch so he could cart along more of their stuff. Something went wrong, the engine caught fire, and the vehicle was soon engulfed in flames. Dylan and his wife barely had time to stop and jump out.
...
Why would anyone re-create the exact same conditions of a tragedy? And why not at least call me before buying what was effectively a replica vehicle. Because Dylan was stuck with his choices, I held my questions back. Instead, we went through the report together. Yes, the engineer suspected a fault in the hitch wiring caused the fire but the vehicle was so charred he was not sure and so could not prove anything in court.

I felt powerless. Saying a kind of "Good luck" was basically all I could do.

After the call ended, the report stayed in my claim file. It was never to be read by the mechanics, automaker, hitch installer. So nobody learned anything and whoever was to blame never got any feedback. As for Dylan, he kept driving his replica vehicle and hoped everything would work out.
...
Like dogs in suburban homes wondering where their food comes from or why the people on television don't smell, we navigate our technological environment with a dangerous lack of understanding, blind to how our tools work, how they affect our society, and most critically, how to learn from failures.
...
This was not unusual. While we understand natural events such as weather patterns and forest fire seasons, we do not study our technological actions. In the thousands of I encountered, we treated each incident as an isolated event, only analyzing rudimentary information like zip codes and driving record months after an accident date. We never connected the complex interactions between environmental, mechanical, and human factors in time to enable prevention.

For example, when thieves were targeting the make and model of a particular vehicle (they take requests from buyers), owners would find out only after they became victims watching their vehicles peel away.

The difference between the two stories is that Courtenay-Latimer had a clear biological framework to interpret the living world. In contrast, Dylan and we have no such framework when dealing with the gadgets, tools, machines, and other 'creatures' of our modern economy.

We need frameworks to explain the wondrous Universe to us; we are lost without them. During the Black Plague (1346-1353), which killed between one-third and one-half of Europe's population, a convent of nuns survived simply because they boiled their laundry and therefore unknowingly killed the disease-carrying ticks at a time when others blamed "spontaneous generation" or the Devil. Similarly, until the late 1800s, millions of soldiers, workers, and ordinary people died from infected wounds because we did not understand the lifesaving power of cleaning wounds with alcohol. It was once common to think Earth was only 5,000 years old and all creatures were created in their current forms with no ancestors at all.
...
The paradigm shift happens when you see that every technology is animated by a human user, much like how Life animates the adaptations of any creature. Just as biological organisms seek to survive and reproduce, each technological tool and its user develops strategies to survive and spread. It's the ecosystem's role to maintain balance and health. In the case of opioids, this system of technological checks and balances collapsed once people could drive anywhere to obtain drugs. Being self-aware of our technological evolution — what I call Techvolution — would have revealed the dangerous mismatch between opioid and car "tool users" and the pharmacists, networks, and databases meant to keep them in check.

The paradigm shift happens when you recognize that technology and humans have a symbiotic relationship. Tools are fully brought to life by its human user, much like how Life animates the adaptations of any creature. Just as biological organisms seek to survive and reproduce, each technological tool and its user develops strategies to survive and spread. It's the ecosystem's role to maintain balance and health. In the case of opioids, this system of technological checks and balances collapsed once people could drive anywhere to obtain drugs. Being self-aware of our technological evolution — a field of study I call Techvolution — would have revealed the dangerous mismatch between opioid and car "tool users" and the pharmacists, networks, and databases meant to keep them in check.

Instead of proactively understanding the technological ecosystem's evolutionary behavior, we responded like other creatures: encountering failure and then evolving a solution. Louisiana, for instance, implemented a prescription management system in 2003, but by then, the damage was already extensive. With their access to prescription opioids restricted, addicted patients swiftly evolved, shifting from legal prescription drugs to heroin and then to fentanyl — drugs beyond the reach of any legal tracking system. Like many who have witnessed this epidemic, I know too many heartbreaking examples of this tragic progression firsthand.

A Progressive might say government would have acted faster but for Conservatives and their anti-government agendas getting in the way. A Conservative might argue government overreach prevented the free market from finding a solution because of needless regulation. A person of faith might point to the collapse of the nuclear family removing America's moral center and inviting addictions into our homes, while an activist might say the systematic oppression of poor communities left them vulnerable to despair and in need of an escape. All of these perspectives might contain some truth, but what is absolutely certain is that the problem was first and foremost caused by a technology: highly addictive opioids purchased by people with the mobility to drive anywhere to buy them. Opioids plus car created a technological organism that required a technological counterpoint to maintain balance within its ecosystem.
...
Millions of Americans continue to suffer and die in the opioid epidemic because we do not yet accept the simple, honest truth of this new paradigm. We live in a technological ecosystem that demands careful and honest study if we are to master our collective fate.

The first step is realizing we are a technological species who cannot navigate our technological wilderness without a framework to guide us. While researching this book, a new friend was open about her extreme social anxiety. I learned I need not be so hard on myself and could simply tell people (or indicate if I couldn't) about my speech problems. Wow, this mindset was liberating and helped infuse my thinking. There was no mask to wear, no falsehood for me to maintain. By indicating a problem with my communication tool, I was separating my self-worth from a technical limitation. And it worked; I rarely received any pushback. A few times when insurance customers would mock me, I'd politely say, "I'll hang up if you do that again" and they never did. Worst case scenario I'd lose my job, and that's a small price to pay for freedom.

Most liberating was learning to spot others' similar plights and recognize that their true challenge was a technological deficiency that could hopefully be corrected or worked around, and if not, then always at least empathized with. I did this during claim calls. Asking questions about a person's situation—whether dealing with a burnt-out house, a messy divorce, or a sick parent—usually gave them great relief and ability to direct their energy to overcoming whatever technical problem was causing them pain.

Now let's apply our sympathy for someone's technological situation to Dylan's experience with driving cars and trucks. When he learned to drive in the 1960s, vehicles had around 20 semiconductors; his SUV had about 3,000, each a potential point of failure that could have caused a fire. In that time period, the average person transitioned from having a single home telephone, radio, and TV to the dozens of devices that now fill our homes and pockets. Without comprehensive study of these "technological creatures" and the honesty to admit we need help, individuals are left navigating increasingly complex technological landscapes under masks of "homeowner", "manager", or "executive" that must pretend to be masters of their own fate.

Before I openly informed people of my problematic speech, I often did the same. Similarly, so many co-workers, employees, and managers must pretend they know how new technology works or just ignore it altogether. Either way, with such rapid technological advancement, most people in our economy today are running blind, hoping their recommended car repairs are actually needed, their identity remains secure, their insurance covers whatever happened to them, and AI won't transform their job duties. We're not unlike our ancestors who travelled the world hoping to find food, water, and shelter in an environment they didn't even have maps for.

Our existing identities and ideological frameworks are not enough to navigate this complex technological landscape. Ideologues can't assess the entire tree of life because at times that would require self-assessment and risk cutting off the branch they are standing on. This inability to understand our technological wilderness fuels increasing polarization, each ideology searching for scapegoats as they struggle to make sense of the accelerating complexity of our technology-driven lives.

Techvolution helps us map our technological environment. It explains how our tools and systems develop according to same principles of biological adaptation. By aligning our political, economic, and social frameworks with the fundamental "pillars of evolution" — ecosystems, natural selection, adaptation, speciation, and co-evolution — we can enable more sustainable and adaptive technological progress across our personal lives, job markets, and economies.

Now that we see how technology changed our environment, and why we need to study this new wilderness, we can preview the new thinking needed to enjoy our place in the world. 

We must evolve the ability to change our tools when needed. Mixed-Ideological Politics is the new political philosophy that puts technological evolution into our hearts and minds. It teaches individuals how to flexibly combine tools and belief systems to optimize their results. Similar to Mixed-Martial Arts, where fighters train in multiple sub-disciplines and cultures while ultimately prioritizing real-world effectiveness, this approach encourages people to transcend rigid ideological boundaries and focus not on ideological purity, but practical solutions to soul-sucking car traffic, confusing insurance forms, and other real-life pain points.

Bumble-Bee Economics is the consciounes construction of technologies, tools, and policy to facilitate evolution inside technological ecosystems. Biological ecosystems are intricate networks where organisms communicate and exchange resources, much like a living internet where trees, fungi, animals, and microbes constantly trade nutrients, information, and support. While evolution involves "survival of the fittest", most creatures rarely compete directly. Instead, like an orchestra, they play individual parts that harmonize into a complex ecosystem—cooperating and adapting in ways far more interdependent than we traditionally imagine.

We can re-create biological ecosystems in our modern economy using open-source software's collaborative model. Like scientific communities, open-source creators prioritize shared progress over individual profit. Designers, inventors, and programmers contribute to projects, creating tools that anyone can use, modify, or improve, and crucially can persist regardless of a single organization's or business's health. Open-source approach treats technology as a living ecosystem that naturally selects and evolves toward better solutions and battles humanity's habit of resisting advancement for selfish reasons.
...
Open-source doesn't replace business; instead, it powers an ecosystem that facilitates commerce through standardized tools. Consider spoken languages like English: nobody owns it, but it's an open system anyone can use to communicate. Products like movies or purchase agreements can be protected, while the underlying language remains free. This ensures that when specific tools or users perish, the broader ecosystem continues to evolve and generate new forms of communication.

Remember tools and their users are a species, and English one of the ways the technological ecosystem communicates. Therefore the language must be free in order to keep the ecosystem evolving new products.

Open-source technology would very much help the Dylan SUV and opioid problems via a universal platform to collect anonymized information from diverse sources. Just as software contributors collaborate without knowing each other, professionals like mechanics, insurance adjusters, and even social media witnesses could contribute insights into a shared knowledge base.

The power of open-source is its ability to rapidly prototype solutions without waiting for institutional approval. Like a universal language, it facilitates communication between separate businesses and organizations, free from market constraints. It exists as Wikipedia does: a foundational tool that can emerge anywhere based on the ecosystem's needs, independent of any single organization's permission or profit motive.

The open-source model is wildly successful in a few select economic sectors. In this way our modern technological ecosystem is budding like a flower, yet we consistently prevent it from blossoming. We mistakenly view new technologies as optional when they are increasingly becoming essential. Consider how smartphones, once dismissed as unnecessary luxuries, became indispensable within a decade. Similarly, businesses that resisted e-commerce and telecommuting found themselves struggling to survive during the COVID pandemic. These aren't mere stories of adaptation—they're evidence of our resistance to evolving as technological beings.

Techvolution challenges your fundamental beliefs about human nature and society by making you conscious of our never-ending technological journey. We must always remember technological progress evolves not through human control, but through a process analogous to biological evolution, a dynamic system where tools and technologies develop through selection, innovation, and interaction. Just as natural selection favors the most adaptive organisms, technological evolution selects the most effective tools. Our role is to understand these principles, build the open-source technologies that facilitate ongoing evolution, and empower those who experience a problem to choose the most effective solution. This approach will transform our economy, enabling individuals to reimagine and reshape their work, learning, and daily experiences—turning passive consumers into active innovators.

Just as understanding gravity opened the cosmos and accepting evolution revealed life's  complexity, grasping our technological evolution will illuminate our path forward. This book is not a definitive answer, but an invitation to explore a new blueprint for unlocking human potential.

By recognizing ourselves as a technological species, we can deliberately shape our future. Innovation becomes our collective tool for creating a more prosperous, peaceful, and sustainable world for all. As you read, you will begin to see technological evolution all around you: checks and balances, living fossils, co-evolution, and most importantly realize what technological creature is looking back at you in the mirror. So, remember you are not just observing evolution—you are already participating in it.

By recognizing ourselves as a technological species, we can deliberately shape our future. Innovation becomes our collective tool for creating a more prosperous, peaceful, and sustainable world. As you flip more pages, you'll begin to see technological evolution everywhere: checks and balances, living fossils, co-evolution. Then you'll look in the mirror and recognize the technological creature staring back. Remember: you are not just reading about evolution—you are already doing it.
