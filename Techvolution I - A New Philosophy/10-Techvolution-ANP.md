...
I was a claims adjuster for about seven years. It's not a job you brag about at parties. Most people's eyes glaze over when you mention insurance. They picture endless paperwork and office small talk. Which is absolutely true, the job is quite mundane. But the stories... Robberies, crashes, fires and other raw details from the frontline of our society ended up on my desk and these tales always quiet the room.

Insurance companies are technically "second party" to customers, meaning adjusters can ask any question we need to verify that a claim is valid. By getting into peoples shoes, the job is basically a massive experiment on our economy to anyone curious enough to listen. With this in mind, I spoke with 30,000+ people, processed 7,000+ claims, and kept notes and journal all throughout.

One claim was particularly illuminating. It was for a gentleman named Dylan. He and his wife were driving down to Florida for a vacation. He had a large SUV and paid a shop to install a tow hitch so he could cart along more of his stuff. Something went wrong, the engine caught fire, and the vehicle was soon engulfed in flames. Dylan and his wife barely had time to stop and jump out.
...
Why would anyone re-create the exact same conditions of a tragedy? And why would he not at least call me before buying what was effectively a replica vehicle. Because he was stuck with his choices I held my questions back. Instead, we went through the report and I felt very awkward doing so. Yes, the engineer suspected a fault in the hitch wiring caused the fire but the vehicle was so charred he was not sure and so could not prove anything in court.
...
This story is not even unique. In the thousands of claims I saw, from car crashes on the way home from the movies, to a house explosion from a natural gas leak, to furnace failures in the middle of winter, most people most of the time were remarkably ignorant of the technological world we've built. Like dogs in suburban homes wondering where their food comes from or why the people on television don't smell, we navigate our technological environment with a dangerous lack of understanding, blind to how our tools work, how they might fail, and most critically, how we might learn from those failures.
...
She was looking at was a coelacanth, a fish species scientists thought died off alongside the dinosaurs 66 million years ago. When news spread, the scientific community was electrified. Not only with finding a "living fossil", but especially because the coelacanth's unique anatomy, particularly its muscular, limb-like fins that are almost like "legs", allowed biologists to study a crucial piece of evolutionary history - showing how fish might have first developed the ability to "walk" onto land.

When Courtenay-Latimer saw the coelacanth, the theory of evolution was not even a 100 years old. In that short time, because the theory was so accurate, scientists had created a comprehensive "tree of life" to explain all the different branches of existence Earth's creatures have taken in their quest to survive and procreate. Even more impressive was the fact that Courtenay-Latimer was not even an official scientist, but a nurse who studied naturalism as a hobby.

Compare Courtenay-Latimer's knowledge to our modern technological understanding. She saw a fish no one had ever seen before and recognized its evolutionary history and importance while Dylan's SUV vehicle fire represented a potential systemic failure, yet no one — not his mechanics, tow hitch installers, automaker, or insurance company — sought to understand the broader implications. This was not unusual. While we understand natural events such as weather patterns and forest fire seasons, we do not study our technological actions. In the 7,000+ claims I processed, we treated each incident as an isolated event, only analyzing rudimentary information like zip codes and driving record months after a accident date. We never connected the complex interactions between environmental, mechanical, and human factors in time to enable prevention. For example, when thieves were targeting the make and model of a particular vehicle (they take requests from buyers), owners would find out only after watching their vehicles peel away.

The difference between the two stories is that Courtenay-Latimer had a clear biological framework to interpret the living world. Whereas Dylan and we have no such framework when dealing with the gadgets, tools, machines, and other "creatures"' of our modern economy.
...
As a result anyone who's watched a nature documentary has a clear understanding of the living world. Aftering seeing the amazing BBC Planet Earth we can walk through a forest accompanied by a consciousness for Life's Darwinian evolution. We know that each organism plays a precise role: predators control herbivore populations, decomposers break down organic matter, and plants efficiently cycle nutrients. The diversity of species — from microscopic fungi to towering trees — creates a resilient network where no single organism dominates. Predator-prey relationships, symbiotic interactions, and genetic variations maintain a complex, self-regulating environment.

Specialists understanding of the natural world goes even deeper. Behind the scenes there are chemical phoramone communication, ultraviolet light shows, mico-organism parties, and so much more for chemists, ecologists, biologists to spend their lives uncovering. A few centuries ago humanity looked at the woods and felt a member to the ecosystem. We used mythologies to make sense of the wonders of Life. Science lifted these veils from our eyes. There are always more layers to peel away, but today we increasingly understand how the story of Life works.
...
The paradigm shift occurs when we accept this fundamental transformation: we are now a technological species. As we evolved away from chimps, we have also evolved away from our homo sapien ancestors clothed in furs walking barefoot looking for a cave. Once we embrace our technological identity, we can begin to map the intricate branches of the technological tree of Life we now inhabit.

Until we adopt this new perspective, we will continue to misinterpret the modern economy through outdated ideological lenses. We'll focus on human created stories and metrics like corporate press releases and Gross Domestic Product numbers, blind to the fundamental reality: technology is now a living ecosystem that evolves according to its own dynamic rules, just like biological systems.

To take a peak at the technological evolution and ecosystems in our real-world, let's use medical insurance.
...
The Project has made presentations and data available for multiple overhauls of the medical system, most notably in 1994 and 2007. Yet, after over 30 years since the project stated, has America gotten healthier? Has medical paperwork become easier? Are medical insurance premiums cheaper? Of course not. The exact opposite is the case.

The Dartmouth Atlas Project has encountered significant challenges in expanding its mission. Funding has been difficult to secure because healthcare stakeholders have often resisted opening their databases, not wanting to risk being exposed as doing a more expensive and less effective job. In addition to the resistance of vested interests, there is the technical challenge of th US healthcare system's lack of standardized data collection. Even simple differences like day/month/year vs. month/day/year cause havoc for anyone trying to combine datasets. The next obstacle is ideological. Both Left and Right are too defensive about their preferred healthcare models—government or corporate—to objectively assess the entire healthcare ecosystem.
...
The opioid epidemic starkly illustrates the consequences of not seeing, and therefore not studying, our modern economy as a technological ecosystem subject to evolution's rules. Pharmacists are supposed to monitor their patients drugs to ensure safety. In the 1990s, most pharmacists had computerized records and internet access to help them service their patients. But they did not share their databases with other pharmacists. Meanwhile some corrupt physicians prescribed massive quantities of addictive painkillers and these troubled patients drove to multiple pharmacies to get their drugs. Hundreds of thousands of Americans thus became addicts and no one noticed. The Netflix documentary _The Pharmacist_ showcases Louisiana's version of this tragic story.

As addicts lives fell apart, family members realized in horror how secretly sick their loved ones were. Mothers, fathers, wives and husbands tried to help via activism, legislation, regulation, and community efforts. All helped but none were enough. The opioid epidemic continued to consume entire communities, overwhelming local resources and social networks.

The opioid epidemic was fundamentally a technological problem, foreseeable when we recognize how technologies shape our lives. In small communities, pharmacists could track prescription abuse through local networks, with "friction of distance" naturally limiting the damage a corrupt physician could do. But cars, affordable gasoline, and extensive road networks destroyed these natural oversight mechanisms, allowing addicts to bypass local monitoring and corrupt doctors to expand their sales.

Then opioids arrived, and the consequences were inevitable. While the drug was designed as a safer painkiller with layered active agents meant to release slowly into a patient's bloodstream, people seeking intoxication quickly discovered they could crush the pill to achieve an immediate, intense high that was incredibly addictive.

The paradigm shift happens when you see that every technology is animated by a human user, much like how Life animates the adaptations of any creature. Just as biological organisms seek to survive and reproduce, each technological tool and its user develops strategies to survive and spread. It's the ecosystem's role to maintain balance and health. In the case of opioids, this system of technological checks and balances collapsed once people could drive anywhere to obtain drugs. Being self-aware of our technological evolution — what I call Techvolution — would have revealed the dangerous mismatch between opioid and car "tool users" and the pharmacist and databases meant to keep them in check.

Instead of being self-aware of the evolutionary behavior of our technological ecosystem, we acted like other creatures. We encountered failure and then evolved a solution. For example, Louisiana finally implemented a prescription management system in 2003, but by then, the damage was done. With their access restricted, addicted patients evolved by shifting from prescription opioids to heroin and then fentanyl — drugs not tracked by the new system. Like many people, I know too many heartbreaking examples of this tragic progression firsthand.

A Progressive might say government would have acted faster but for Conservatives and their anti-government agendas getting in the way. A Conservative might argue government overreach prevented the free market from finding a solution because of needless regulation. A person of faith might point to the collapse of the nuclear family removed America's moral center and invited additions into our homes, while a activist might say the systematic oppression of poor communities left them vulnerable to despair and a need to escape. All of these perspectives might contain some truth, but what is absolutely certain is that the problem was first and foremost caused by a technology: highly addictive opioids purchased by people with the mobility to drive anywhere to buy them. Opiods plus car created a technological organism that required a technological counter point to maintain balance within its ecosystem.
...
The first step is realizing we are a technological species who cannot navigate the new wilderness without a framework to guide us. Consider my speech impediment. When a friend was open about her extreme social anxiety, I learned I need not be so hard on myself and could simply tell people (or indicate if I couldn't) about my speech problems, and wow, this mindset was liberating. There was no mask to wear, no falsehood to maintain. By indicating a problem with my communication tool, I was separating my self-worth from a technical limitation. And it worked; I rarely received any pushback. A few times when insurance customers would mock me, I'd politely say, "I'll hang up if you do that again" and they never did.

Most liberating was learning to spot others' similar plights and recognize that their true challenge was a technological deficiency that could be corrected or worked around but always empathazied with which always gave great relief.

Now lets apply our sympathy for someone's technological capabilities with Dylan's experience with driving cars and trucks. When he learned to drive in the 1960s, vehicles had around 20 semiconductors; his SUV had about 5,000, each a potential point of failure that could have caused a fire. In that time period, the average person went from having a single home telephone, radio, and TV, to the dozens of devices that fill our homes and pockets today. Without comprehensive study of these "technological creatures" and the honesty to admit we need help, individuals are left navigating increasingly complex technological landscapes under masks of "homeowner", "manager", or "executive" that must pretend they are masters of their own fate. In fact, today most people are running blind hoping their car keeps running or their identity is not stolen. We're not unlike our ancestors who travelled the world hoping to find food, water, and shelter in an environment they didn't even have maps for.
...
Techvolution will help us map our technological environment. It explains how our tools and systems develop according to same principles of biological adaptation. By aligning our political, economic, and social frameworks with the fundamental "pillars of evolution" — ecosystems, natural selection, adaptation, speciation, and co-evolution — we can enable more sustainable technological progress across our personal lives, job markets, and economies.

Mixed-Ideological Politics puts technological evolution into our hearts and minds. It teaches individuals how to flexibly combine tools and belief systems to optimize their actions. Similar to Mixed-Martial Arts, where fighters train in multiple sub-disciplines and cultures while ultimately prioritizing real-world effectiveness, this approach encourages people to transcend rigid ideological boundaries and focus not on ideological purity, but practical solutions to their real-life pain points such as soul-sucking car traffic or confusing insurance forms.

Bumble-Bee Economics facilitates evolution inside the technological ecosystem. Biological ecosystems are interconnected through intricate networks of chemical signals, cellular interfaces, and symbiotic structures that allow different organisms to communicate and exchange resources, much like a complex, living internet where trees, fungi, animals, and microbes constantly trade nutrients, information, and support. Just as a squirrel and a tree might collaborate through root networks and seed dispersal, these microscopic "communication highways" enable life forms to work together, adapt, and survive in ways that are far more cooperative and interdependent than we traditionally imagine.

We can re-create this network because of open-source software's collaborative model. Like scientific communities, open-source creators prioritize shared progress over individual profit. Designers, inventors, and programmers contribute to projects, creating tools that anyone can use, modify, or improve, and crucially can persist regardless of a single business's health. Open-source approach treats technology as a living ecosystem that naturally selects and evolves toward better solutions and battles humanity's habit of resisting advancement for selfish reasons.
...
Open-source doesn't replace business; instead, it powers an ecosystem that facilitates commerce through standardized tools. Using the Dylan SUV and opioid examples, a universal platform could collect anonymized information from diverse sources. Just as software contributors collaborate, professionals like mechanics, insurance adjusters, and even social media witnesses could contribute insights into a shared knowledge base. This approach requires the self-awareness that documenting and sharing critical information greatly advances our shared technological ecosystem.

The greatness of open-source is that it could start this tool within a few weeks of work and not have to wait for someone else's approval to start. Its a tool designed to interconnect seperate business and thus is free from market forces. It exists as Wikipedia exists, a foundational tool that can always exist anywhere in the world based on the need of the ecosystem.
...
Techvolution challenges your fundamental beliefs about human nature and society by making you conscious of our technological journey. Technological progress evolves not through human control, but through a process analogous to biological evolution, a dynamic system where tools and technologies develop through selection, innovation, and interaction. Just as natural selection favors the most adaptive organisms, technological evolution selects the most effective tools. Our role is to understand these principles and empower those who experience a problem to choose the most effective solution. By cultivating this self-awareness, we can design, create, and adopt tools more likely to thrive in the ever-evolving technological ecosystem we now inhabit.

Techvolution challenges your fundamental understanding of human progress. Technological evolution is not controlled by our beliefs, ideologies, or desires, but follows its own adaptive logic that we already understand via to biological evolution. Just as nature selects the most resilient organisms, technology selects the most effective tools. Our task is to understand this process and empower people feeling the pain of a problem to decide on the most helpful solution. By becoming aware of these evolutionary dynamics, we can create tools that survive and thrive faster in our rapidly changing technological ecosystem.
...
By recognizing ourselves as a technological species, we can deliberately shape our future. Innovation becomes our collective tool for creating a more prosperous, peaceful, and sustainable world for all. As you read, you will begin to see technological evolution all around you: checks and balances, living fossils, co-evolution, invasive species, and most importantly realize what technological creature is looking back at you in the mirror. So, remember you are not just observing evolution—you are already participating in it.
