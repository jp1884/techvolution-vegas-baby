...
Car insurance adjusters get the most random calls. Doris lost her purse in Paris. Steve parked his car on a frozen lake, fell asleep, and watched it sink. A world of problems called looking for help, and we adjusters had only telephones and Google to be there.

The call center was mayhem, with adjusters almost always desperately trying to keep up. At least once or twice a year, stress would send a co-worker away in an ambulance. Among our many challenges were callers who didn't speak English. After watching a colleague desperately walk our cubicles asking "Vietnamese, does anyone speak Vietnamese?" (dark humor at its finest), I helped create a list of everyone's second languages to help weather these linguistic storms.
...
In the sitcom Seinfeld, Elaine lies to a couple about dating a matador. When Jerry learns of her deception, he mockingly halts conversation with "Uno momento por favor."

That's exactly how much Spanish I knew, and surprisingly, it worked. The caller was delighted to hear even poorly pronounced Spanish. I found Paul on our language list, and together we helped this nice lady start her claim - she needed it after one of our company's customers hit her car while on vacation in the Lone Star state.
...
Some tools require minimal supervision or input. Street signs and house numbers make the world easy to navigate but are set it and forget it technologies. Others like hammers or airplanes don't do anything unless we wield them. Regardless of our involvement, every tool exists inside an ecosystem, so in order for the technological ecosystem to prosper, human society which operates it, must be structured to empower the technological ecosystem.

One way to see how human society affects the technological ecosystem how the languages we speak affecs our prosperity.

Language is a fundamental technology that structures human societies, defining territorial boundaries, creating communication networks, and determining information flow that shapes economic and social interactions. Anyone who has been lost in a foreign country knows the profound isolation of not speaking the local language. Language functions as critical economic infrastructure, facilitating communication, determining transaction costs, and enabling knowledge transfer. 

Considering language as a technology may seem odd, but the ability to create sounds requires a tool of some kind, as does teaching verbal and written language. Just as Frederick Douglass discovered how reading could unlock entire worlds of possibility, languages represent technological systems that enable or constrain human potential.

Like any tool, humans do not always use language optimally. The biggest problem is not too few, but actually too many.

A person speaking a language requires another who can understand it. Languages is the ultimate example of the network effect. The more people who use a technology the easier, better, and more reasonable it becomes to join in yourself. The ease of using WhatsApp or iMessage is just a few examples of the benefits of diverse people using the same platform to communicate. The same idea applies to languages, in what historians call "lingua franca", which is a historical term for an area having a standard language like Greek, Latin, French, or today English, to speak between strangers.

Language goes beyond communication. It denotes a similar set of customs, conventions, and beliefs that people who are to work together must share to some degree. A traveller not speaking the local language is just one of the many ways in which she is isolated from the community. Learning about our ignorance is what can make travelling so much fun.
